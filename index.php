      ...
      <div class="col">
        <div>
          ...
          <ul>
            <?php
            $totalMonsths= 0 ;
              for ($experience = 0; $experience < count($jobs); $experience ++ ) {
                // $totalMonsths = $totalMonsths + $jobs[$experience]['months'];
                $totalMonsths += $jobs[$experience]->months;
                if ($totalMonsths > $limitMonsths) {
                  # code...
                  break;
                }
                  printElement($jobs[$experience]);
                }
            ?>
          </ul>
        </div>
